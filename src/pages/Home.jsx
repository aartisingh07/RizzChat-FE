...
let socket = io("https://rizzchat-be-bggr.onrender.com/");
...
function Home(){
  ...
  useEffect(()=>{ //so that user doesn't reach home page without login through browser address by typing /home in address bar
  ...
  useEffect(() => { //for smooth scrolling inside chats
